    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item
            :to="{
              path: `/category/${goodDetail?.categories[1]?.id}/sub/${goodDetail?.categories[0]?.id}`,
            }"
          >
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
              <xtx-image-view :image-list="goodDetail?.mainPictures" />
              <!-- 统计数量 -->
          ...
          <div class="goods-footer">
            ...
            <div class="goods-aside">
              <detail-hot :type="HotType.DAY" />
              <detail-hot :type="HotType.WEEK" />
            </div>
          </div>
        </div>
      </div>
